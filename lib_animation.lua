...
--[[
    ...
    loop [Boolean] : whether or not to loop the animation
--]]

local Animation = {}
Animation.__index = Animation

function Animation.new( x, y, delay, image, framesWide, framesHigh, loop )
  local this = {}
...
function Animation:draw(x, y, r)
  ...
  love.graphics.draw( self.image, self.quad, self.x + x, self.y + y, self.rotation + r, self.scale.x, self.scale.y, self.offset.x, self.offset.y, self.shear.x, self.shear.y )
end
